...
export const OptionsPage = (): JSX.Element => (
  // The negative margin cancels the main area's own padding, so the bar rides
  // the edge of the window instead of floating a few centimetres inside it; the
  // padding is put straight back so the content itself does not move.
  <div className="scroll-area -mr-6 flex h-full flex-col gap-3 overflow-y-auto pr-6 lg:-mr-10 lg:pr-10">
